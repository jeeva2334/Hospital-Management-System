        ...
        <div className="flex">
            ...
            <div className='h-[100vh] mt-[42rem] w-[100vw] p-20 flex flex-col justify-center items-center'>
                <div className='bg-white w-[90vh] p-2'>
                    ...
                    <label htmlFor="Fullname" className="block mb-2 text-xl underline font-medium text-gray-900 dark:text-white">General</label>
                    <div className="mb-6">
                        <label htmlFor="wardno" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ward type : </label>
                        <input type="text" name='wardtype' id="wardno" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ward no" required onChange={handleChange} />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="wardno" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ward no : </label>
                        <input type="text" name='wardno' id="wardno" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ward type" required onChange={handleChange} />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="Admitted" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of days Admitted: </label>
                        <input type="text" name='noofaddmitteddays' id="Admitted" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="no of days Admitted" required onChange={handleChange} />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="AdmittedDate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Admitted Date: </label>
                    ...
                    <div className="mb-6">
                        <label htmlFor="discharge" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date of discharge: </label>
                        <input type="date" name='dischargeDate' id="discharge" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="no of days Admitted" required onChange={handleChange} />
                    </div>
                    <label htmlFor="" className="block mb-2 text-xl underline font-medium text-gray-900 dark:text-white">Tests </label>
                    <div className="mb-6">
                        <label htmlFor="labname" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lab name : </label>
                        <input type="text" name='labname' id="labname" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="labname" required onChange={handleChange} />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="test" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Test and result : </label>
                        <textarea type="text" name='testres' id="test" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="test & result" required onChange={handleChange} />
                    </div>
